export const startups = [
...

  {
    ...
    description:
      "An AI-powered digital physical therapy provider that connects users with clinical teams to treat musculoskeletal conditions remotely.",
    is_seeking_funding: true,
    has_mvp: true,
  },
  {
    ...
    lng: 25.4663,
    founders: [
      { name: "Petteri Lahtela", role: "Co-Founder" },
    ...
    description:
      "Creators of the Oura Ring, a smart wearable that tracks sleep, activity, and recovery to provide personalized health insights.",
    is_seeking_funding: false,
    has_mvp: true,
  },
  {
    ...
    lng: 18.0484,
    founders: [
      { name: "Johannes Schildt", role: "CEO" },
    ...
    description:
      "A leading digital healthcare provider in Europe allowing patients to consult with doctors and psychologists via video in minutes.",
    is_seeking_funding: true,
    has_mvp: true,
  },
  {
    ...
    lng: 2.3631,
    founders: [
      { name: "Jean-Charles Samuelian-Werve", role: "CEO" },
    ...
    description:
      "A digital health insurance platform that provides transparent healthcare services, telemedicine, and wellness programs for companies.",
    is_seeking_funding: false,
    has_mvp: true,
  },
  {
    ...
    description:
      "A immunotherapy giant pioneering mRNA technology to develop vaccines and therapies for cancer and infectious diseases.",
    is_seeking_funding: false,
    has_mvp: true,
  },
];
